...
class AdminController extends Controller {
    public function dashboard(Request $request) {
        ...
        $todaySales = Order::whereNotIn('status', ['Pending Payment', 'Payment Failed', 'Cancelled'])
            ->whereBetween('created_at', [now()->startOfDay(), now()->endOfDay()])
            ->sum('grand_total');
        $totalOrders = Order::whereNotIn('status', ['Pending Payment', 'Payment Failed', 'Cancelled'])->count();
        $totalRevenue = Order::whereNotIn('status', ['Pending Payment', 'Payment Failed', 'Cancelled'])->sum("grand_total");
        ...
        $dailySales = Order::whereNotIn('status', ['Pending Payment', 'Payment Failed', 'Cancelled'])
