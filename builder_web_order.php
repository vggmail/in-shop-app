...
<body>
    ...
    <div class="modal fade" id="checkoutModal"><div class="modal-dialog modal-dialog-centered modal-lg"><div class="modal-content"><div class="modal-body p-4">
        ...
        <div class="row g-3 mb-4">
            <div class="col-12"><input type="text" id="cust_name" class="form-control form-control-lg border-0 bg-light rounded-3" placeholder="Your Name"></div>
            <div class="col-12"><input type="text" id="cust_phone" class="form-control form-control-lg border-0 bg-light rounded-3" placeholder="Mobile Number (Optional)"></div>
        </div>
    ...
    <script>
        ...
        function submitOrder() {
            ...
            $.post("{{ route(\'home.store\') }}", {
                _token: "{{ csrf_token() }}",
                customer_name: $("#cust_name").val() || "Online User",
...
echo "Customer Facing Web Page with ordering refined.\n";
